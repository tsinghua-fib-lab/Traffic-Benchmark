...
parser.add_argument('--decay_epoch', type=int, default = 5,
                    help = 'decay epoch')
parser.add_argument('--traffic_file', default = 'data/BJ500.h5',
                    help = 'traffic file')
parser.add_argument('--SE_file', default = 'data/SE(BJ500).txt',
                    help = 'spatial emebdding file')
parser.add_argument('--model_file', default = 'data/GMAN(BJ500)',
                    help = 'save the model to disk')
parser.add_argument('--log_file', default = 'data/log(BJ500)',
                    help = 'log file')
args = parser.parse_args()

import setproctitle
setproctitle.setproctitle("GMAN@lifuxian")
import os
